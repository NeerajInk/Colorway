...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      ...
      <a href="http://www.inkthemes.com" target="_new"><div class="icon-option"> </div></a>
      <div class="clear"></div>
    </div>
    <?php 
    ...
    <img style="display:none" src="<?php echo bloginfo('template_directory'); ?>/functions/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />

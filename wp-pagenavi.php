...
function _pagenavi_init() {
	...
	$options = new scbOptions( 'pagenavi_options', __FILE__, array(
		'pages_text'    =>
__( 'Page %CURRENT_PAGE% of %TOTAL_PAGES%', 'colorway' ),
		'current_text'  => '%PAGE_NUMBER%',
		'page_text'     => '%PAGE_NUMBER%',
		'first_text'    => __( '&laquo; First', 'colorway' ),
		'last_text'     => __( 'Last &raquo;', 'colorway' ),
		'prev_text'     => __( '&laquo;', 'colorway' ),
		'next_text'     => __( '&raquo;', 'colorway' ),
		'dotleft_text'  => __( '...', 'colorway' ),
		'dotright_text' => __( '...', 'colorway' ),
		'num_pages' => 5,
